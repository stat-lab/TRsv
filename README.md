...
Alternatively, a singularity container file (TRsv-v1.1.2.sif) is available at [TRsv-v1.1.2.sif](https://drive.google.com/uc?export=download&id=1IS8PGQ9NsdJaHMBUwRVf5iL2NUb1Ng5P). Run using the singularity TRsv-v1.1.2.sif file can be done using a run_TRsv_singularity.pl script in the scripts directory.
